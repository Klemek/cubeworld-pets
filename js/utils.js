...
const data = {
  list: [
    ...
    [20, 'Chocolate Ice Cream,<br>Peanut', 'Baby Mammoth', true, false, false, false],
    ...
    [35, 'Milk Chocolate Bar,<br>Rice Milk Chocolate Bar', 'Plain Runner', true, false, false, false],
