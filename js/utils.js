...
const data = {
  list: [
   //food(0), pet(1), rideable(2), ranged(3), healer(4), tank(5)
    ...
    ['Bloodorange Juice', 'Mosquito', true, false, false, false],
    ...
    ['Candy', 'Cat', true, false, false, false],
    ...
    ['Chocolate Ice Cream', 'Baby Mammoth', true, false, false, false],
    ...
    ['Milk Chocolate Bar', 'Plain Runner', true, false, false, false],
    ['Mineral Water', 'Radishling Sprout', true, false, false, false],
    ...
    ['Raspberry Juice', 'Flamingo', true, false, false, false],
    ['Rice Milk Chocolate Bar', 'Plains Runner', true, false, false, false],
    ...
    ['Strawberry Cocktail', 'Crab', false, false, false, false],
    ['Sugar Candy', 'Duckbill', true, false, false, false],
    ['Vanilla Cupcake', 'Alpaca (light)', true, false, false, false],
